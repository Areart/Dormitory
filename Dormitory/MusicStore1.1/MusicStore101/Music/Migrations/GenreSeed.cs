...
namespace Music.Migrations
{
    public class GenreSeed
    {
        ...
        public static void Seed()
        {
            ...
            {
                new Album {Title="A",Genre=genres.Single(g=>g.Name=="摇滚"),Price=7.99M,Artist=artists.Single(a=>a.Name=="吴莫愁"),AlbumArtUrl="/" },
                new Album {Title="B",Genre=genres.Single(g=>g.Name=="摇滚"),Price=9.99M,Artist=artists.Single(a=>a.Name=="张惠妹"),AlbumArtUrl="/" },
                new Album {Title="C",Genre=genres.Single(g=>g.Name=="爵士"),Price=6.99M,Artist=artists.Single(a=>a.Name=="孙楠"),AlbumArtUrl="/" },
                new Album {Title="D",Genre=genres.Single(g=>g.Name=="重金属"),Price=5.99M,Artist=artists.Single(a=>a.Name=="万晓利"),AlbumArtUrl="/" },
                new Album {Title="E",Genre=genres.Single(g=>g.Name=="慢摇"),Price=8.69M,Artist=artists.Single(a=>a.Name=="赵雷"),AlbumArtUrl="/" },
                new Album {Title="F",Genre=genres.Single(g=>g.Name=="蓝调"),Price=2.99M,Artist=artists.Single(a=>a.Name=="孙楠"),AlbumArtUrl="/" },
                new Album {Title="G",Genre=genres.Single(g=>g.Name=="拉丁"),Price=3.99M,Artist=artists.Single(a=>a.Name=="Fine乐团"),AlbumArtUrl="/" },
                new Album {Title="H",Genre=genres.Single(g=>g.Name=="流行"),Price=5.99M,Artist=artists.Single(a=>a.Name=="洪启"),AlbumArtUrl="/" },
                new Album {Title="I",Genre=genres.Single(g=>g.Name=="古典"),Price=6.99M,Artist=artists.Single(a=>a.Name=="王三溥"),AlbumArtUrl="/" },
                new Album {Title="J",Genre=genres.Single(g=>g.Name=="DJ"),Price=8.69M,Artist=artists.Single(a=>a.Name=="孙楠"),AlbumArtUrl="/" },
                new Album {Title="K",Genre=genres.Single(g=>g.Name=="嘻哈"),Price=8.99M,Artist=artists.Single(a=>a.Name=="老狼"),AlbumArtUrl="/" },
                new Album {Title="L",Genre=genres.Single(g=>g.Name=="流行"),Price=7.99M,Artist=artists.Single(a=>a.Name=="吴莫愁"),AlbumArtUrl="/" },
                new Album {Title="N",Genre=genres.Single(g=>g.Name=="流行"),Price=5.99M,Artist=artists.Single(a=>a.Name=="王三溥"),AlbumArtUrl="/" },
                new Album {Title="M",Genre=genres.Single(g=>g.Name=="嘻哈"),Price=8.99M,Artist=artists.Single(a=>a.Name=="老狼"),AlbumArtUrl="/" },
                new Album {Title="O",Genre=genres.Single(g=>g.Name=="古典"),Price=7.99M,Artist=artists.Single(a=>a.Name=="吴莫愁"),AlbumArtUrl="/" },
                new Album {Title="P",Genre=genres.Single(g=>g.Name=="爵士"),Price=5.99M,Artist=artists.Single(a=>a.Name=="万晓利"),AlbumArtUrl="/" },
                new Album {Title="Q",Genre=genres.Single(g=>g.Name=="拉丁"),Price=7.99M,Artist=artists.Single(a=>a.Name=="吴莫愁"),AlbumArtUrl="/" },
                new Album {Title="R",Genre=genres.Single(g=>g.Name=="DJ"),Price=5.99M,Artist=artists.Single(a=>a.Name=="老狼"),AlbumArtUrl="/" },
                new Album {Title="S",Genre=genres.Single(g=>g.Name=="DJ"),Price=5.99M,Artist=artists.Single(a=>a.Name=="万晓利"),AlbumArtUrl="/" },
                new Album {Title="T",Genre=genres.Single(g=>g.Name=="重金属"),Price=5.99M,Artist=artists.Single(a=>a.Name=="老狼"),AlbumArtUrl="/" },
